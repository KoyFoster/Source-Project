...
const defaultData = {
  ...
  Values: [
    ...
    [
      ...
      ['Melee Attack', 4.4 /*376.4*/, 4.4, 2560, '', [0, 1], 'a * 0.2'],
      ['Range Attack', 4.4 /*4.4*/, 4.4, 2560, '', [0, 2], 'a * 0.2'],
      ['Magic Attack', 4.4 /*4.4*/, 4.4, 2560, '', [0, 5], 'a * 0.2'],
      ['Healing Power', 4.4 /*34.4*/, 4.4, 2560, '', [0, 4], 'a * 0.2'],
      ['Physical Defense', 260 /*260*/, 44, 2560, '', [0, 3], 'a * 1'], // 71.35%
      ['Magic Defense', 260 /*260*/, 44, 2560, '', [0, 3], 'a * 1'], // 23.81%
    ],
