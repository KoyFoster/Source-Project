...
class ImageHandler {
  ...
  setup = (dataTN, imgFormat, imgPath) => {
    ...
    if (i > -1) {
      ...
      if (!this.imgFormat) {
        ...
        this.imgFormat = ImageHandler.getImgTypeID(imgType);
      }
    }
  ...
  getDataFormat(data, id) {
    return `data:image/${ImageHandler.getImgType(id)};base64,${data}`;
  }

  getExt = () => ImageHandler.getImgType(this.data.imgFormat);
